...
public class TileMapSettingsBlackboard : MonoBehaviour, 
    IBlackboardForUI, 
    ISliderReceiver<MyVariableOptions>, 
    IButtonReceiver<MyButtonOptions>
{
    public Action<float, Vector2Int> OnApplyChanges;
    ...
    public void InitializeSliderActions()
    {
        ...
        {
            { MyVariableOptions.TileSize, val => _tileSize = val },
